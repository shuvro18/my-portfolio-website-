  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden
      >
        <Parallax speed={45} className="h-[140%] -top-[20%]">
          <div
            className="w-full h-full"
            style={{
              backgroundImage:
                "radial-gradient(ellipse at 20% 50%, #0f3e27 0%, transparent 55%)",
            }}
          />
        </Parallax>
      </div>
      ...
      <div className="max-w-max-width mx-auto relative z-10">
        <ScrollDepth yOffset={40} scaleFrom={0.96}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-9 items-center">
          <ScrollDepth yOffset={64} scaleFrom={0.9} className="relative group w-full flex justify-center md:block">
            ...
            <Parallax speed={24} className="relative rounded-xl overflow-hidden border border-outline-variant shadow-2xl hover-card-glow">
              <Image
                width={400}
                height={200}
                alt="Shuvro - MERN Stack Developer"
                className="mx-auto hover:grayscale-0 transition-all duration-500 scale-110"
                src={image}
              />
            </Parallax>
          ...
          <ScrollDepth yOffset={48} scaleFrom={0.93} className="space-y-6 pt-8 md:pt-0">
